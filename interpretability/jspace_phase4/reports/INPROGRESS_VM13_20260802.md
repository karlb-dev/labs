...
- A1000 resumed from the exact n=554 handoff checkpoint under the frozen
  router. Atomic checkpoints through n=980 exist as a valid exact pair. Its
  ...
  n=980. Cloud upload remains rate-limited. A temporary recovery-directory
...
| field | value |
|---|---|
| prompts banked | 980 / 1000 |
| durability | exact local + DriveFS-cache pair; cloud upload pending |
| checkpoint SHA-256 | `2b8c3e97fe9a74340f7504f6bcf8cfea32ac088e05dfceaf78640f0bac52ce70` |
| checkpoint-state SHA-256 | `3b5775ffb95cd80c6be08e70ca86510414a6f90622b726e5493ef664125b1956` |
| checkpoint bytes | 6,606,047,399 |
| fit contract | `bf4caff4ff7c389d29f235a91062ae86e3a37dfc526c42bbd9af7c5d7e1f3b00` |
| checkpoint sync UTC | 2026-08-02 21:50:47 UTC |
| peak allocated VRAM | 62.846 GB |
| process state | live; active atomic chunk 980:983; unified session 83477 |

A new raw-log audit corrected the earlier description of prompt 323 as the
overall maximum. Among the archived rows through n=980, prompts 233, 323, 612,
...
722/725 prompts processed`, and is live. Bound syncs through n=980 completed
