...
Last updated: 2026-08-02 12:59 UTC. This is the canonical dynamic handoff.
...
- A1000 resumed from the exact n=554 handoff checkpoint under the frozen
  router. Atomic checkpoints through n=800 exist as a valid exact pair. Its
  ...
  n=800. Cloud upload remains rate-limited. A temporary recovery-directory
  ...
  wrapper is live in chunk 800:803. No partial checkpoint is registered
  evidence.
...
| field | value |
|---|---|
| prompts banked | 800 / 1000 |
| durability | exact local + DriveFS-cache pair; cloud upload pending |
| checkpoint SHA-256 | `f2eaa84a8f17fa2f9bca6ef088ada7a5c0a6ba2f6236caf296fabf0ec36fe95a` |
| checkpoint-state SHA-256 | `74a38e9525880161edfc45a7639d785c3b70bd13fde79f8ae5f8f193ec03bca0` |
| checkpoint bytes | 6,606,047,399 |
| fit contract | `bf4caff4ff7c389d29f235a91062ae86e3a37dfc526c42bbd9af7c5d7e1f3b00` |
| checkpoint sync UTC | 2026-08-02 12:58:08 UTC |
| peak allocated VRAM | 62.846 GB |
| process state | live; active atomic chunk 800:803; unified session 83477 |

Prompts 660 and 796 are retained finite heavy-tail rows at 113.855 and 44.507,
both below the earlier prompt-323 maximum 173.345; no outcome-dependent
trimming or refit occurred.
...
722/725 prompts processed`, and is live. Bound syncs through n=800 completed
