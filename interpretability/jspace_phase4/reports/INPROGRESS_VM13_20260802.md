...
Last updated: 2026-08-02 20:22 UTC. This is the canonical dynamic handoff.
...
- A1000 resumed from the exact n=554 handoff checkpoint under the frozen
  router. Atomic checkpoints through n=950 exist as a valid exact pair. Its
  ...
  n=950. Cloud upload remains rate-limited. A temporary recovery-directory
  ...
  wrapper is live in chunk 950:953. No partial checkpoint is registered
  evidence.
...
| field | value |
|---|---|
| prompts banked | 950 / 1000 |
| durability | exact local + DriveFS-cache pair; cloud upload pending |
| checkpoint SHA-256 | `1c32a45106648830ec5b89a853fcb14182d92d552f05725b8d7507281ec9dc01` |
| checkpoint-state SHA-256 | `40b0e553d7052922f2fb9b0e9a0c99ebaddc4fa247ba9761fe215b03560c5ce9` |
| checkpoint bytes | 6,606,047,399 |
| fit contract | `bf4caff4ff7c389d29f235a91062ae86e3a37dfc526c42bbd9af7c5d7e1f3b00` |
| checkpoint sync UTC | 2026-08-02 20:22:21 UTC |
| peak allocated VRAM | 62.846 GB |
| process state | live; active atomic chunk 950:953; unified session 83477 |

A new raw-log audit corrected the earlier description of prompt 323 as the
overall maximum. Among the archived rows through n=950, prompts 233, 323, 612,
...
rate puts the A1000 checkpoint near 22:50 UTC and final serialization,
registration, backup, integration, and push near 22:55--23:05 UTC. No new
long-running compute should start after 23:25 UTC. If the remaining margin is
insufficient for the complete postfit queue, use the registered-and-backed-up
`JSPACE4_STOP_AFTER=structural` boundary and leave later stages to Phase 4.4.
...
722/725 prompts processed`, and is live. Bound syncs through n=950 completed
