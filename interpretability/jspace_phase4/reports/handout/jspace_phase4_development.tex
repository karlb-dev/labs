...
\normalsize\textcolor{muted}{State through OLMo-3 32B Think ·
2026-07-31}}
\author{}\date{}
...
\begin{enumerate}
\item Bank-S direct and composed specificity is already negative at
3.0 Think and is comparatively stable across fitted frames.
...
\begin{center}\small
\texttt{allenai/Olmo-3-1125-32B}\\
\texttt{revision c2b61dae89a1ad10e4ad5653d0e46b590902607b}
\end{center}
Run G5, a frozen capable direct/composed cohort, and the same
seven-condition grid with the already banked base lens. Then synthesize base
$\rightarrow$ 3.0 Think $\rightarrow$ 3.1 Think/Instruct with both
common-lens and own-lens lines. If they disagree, prioritize the
fit-size/corpus study before stronger causal interpretation.
