...
PYTHONPATH="$prep_py${PYTHONPATH:+:$PYTHONPATH}" \
  pytest -q \
  interpretability/jspace_phase4/tests/test_mode_intervention.py \
  interpretability/jspace_phase4/tests/test_qwen_mode_variance_pilot.py \
  interpretability/jspace_phase4/tests/test_qwen_mode_variance_gpu.py
```
