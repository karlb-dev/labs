...
```bash
prep_py="$PWD/interpretability/jspace_phase4:$PWD/interpretability/jspace_phase3:$PWD/interpretability/jspace_part2"
PYTHONPATH="$prep_py${PYTHONPATH:+:$PYTHONPATH}" \
  pytest -q \
  interpretability/jspace_phase4/tests/test_orthogonal_bridge.py \
  interpretability/jspace_phase4/tests/test_bank_b_orthogonal_analysis.py \
  interpretability/jspace_phase4/tests/test_bank_b_orthogonal_feasibility.py

PYTHONPATH="$prep_py${PYTHONPATH:+:$PYTHONPATH}" \
  python -m jspace_phase4.experiments.p4_bank_b_orthogonal_feasibility \
  --config interpretability/jspace_phase4/configs/p4_bank_b_orthogonal_feasibility_dev.yaml \
  --preflight
```
