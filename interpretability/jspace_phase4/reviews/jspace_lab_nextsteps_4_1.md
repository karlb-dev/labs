...
```text
interpretability/jspace_phase3/preregistration/PHASE3_FREEZE_RECORD.md
```
...
interpretability/jspace_phase4/reviews/PHASE4_PLAN_ACCEPTED.md
interpretability/jspace_phase4/preregistration/SCIENTIFIC_PREREGISTRATION_PHASE4_CANDIDATE.md
interpretability/jspace_phase4/preregistration/DEVIATIONS.md
interpretability/jspace_phase4/protocol/REPRO_CONTRACT_PHASE4.md
```
...
python -m jspace_phase4.experiments.p4_olmo_lineage_grid \
  --config interpretability/jspace_phase4/configs/olmo3-base-dev.yaml
```
