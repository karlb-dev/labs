...
| recall | heads_and_mlps | **OVERFIT / NO CLEAN CIRCUIT** | +0.40 | +0.47 / +1.30 | -0.03 | 54/24 | +0.82 |
| recall | heads_only | **OVERFIT / NO CLEAN CIRCUIT** | +1.02 | +1.00 / +1.08 | +0.08 | 44/7 | +0.08 |
...
- base metric +8.38; n_discovery 14, n_heldout 5.
- knee 54 nodes; floor 24 nodes; knee−floor gap +0.59.
- faithfulness — discovery: resample +0.47, mean +1.30; held-out: resample +0.40, mean +1.20.
- motif-core held-out (resample) -0.03; induction motif present: False.
- suppression heads: 0; positive-causal MLPs: 42; MLPs in knee: MLP50, MLP27, MLP46, MLP38, MLP4, MLP34, MLP31, MLP47, MLP29, MLP40, MLP32, MLP33, MLP35, MLP30, MLP59, MLP24, MLP37, MLP18, MLP26, MLP39, MLP25, MLP44, MLP9, MLP49, MLP45, MLP8, MLP51, MLP16, MLP42, MLP56, MLP58, MLP14.
- edge: L6H37 -> L25H33.

### recall (heads_only) — OVERFIT / NO CLEAN CIRCUIT

- knee transfers (1.02) but the motif core alone does not (0.07546); the extra heads are filler, not mechanism.
- base metric +8.38; n_discovery 14, n_heldout 5.
- knee 44 nodes; floor 7 nodes; knee−floor gap +0.37.
- faithfulness — discovery: resample +1.00, mean +1.08; held-out: resample +1.02, mean +1.04.
- motif-core held-out (resample) +0.08; induction motif present: False.
- suppression heads: 0; positive-causal MLPs: 6; MLPs in knee: none.
- edge: none claimed.
...
- `recall/heads_and_mlps`: OVERFIT / NO CLEAN CIRCUIT — discovery passes but held-out resample faithfulness 0.40 < 0.70.
- `recall/heads_only`: OVERFIT / NO CLEAN CIRCUIT — knee transfers (1.02) but the motif core alone does not (0.07546); the extra heads are filler, not mechanism.
