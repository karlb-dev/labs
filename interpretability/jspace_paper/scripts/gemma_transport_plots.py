...
Output: interpretability/jspace_paper/figures/gmT1_tangent_ladder.png
Run:    cd interpretability/jspace_paper && ../jspace_runs/.venv/bin/python scripts/gemma_transport_plots.py
"""
import pathlib
...
PAPER = HERE.parent
RUNS = PAPER.parent / "jspace_runs" / "gemma_transport_20260802" / "metrics"
