...
\emph{Update (2026-08-02): that experiment has now run in the isolated
\texttt{jspace\_gemma} track and terminated at its own precommitted
cross-backend consistency gate --- see \cref{sec:autopsy-ran}. The track's
terminal classification is a \textbf{methods blocker}, not a mechanism
result.}
\end{statusbox}
