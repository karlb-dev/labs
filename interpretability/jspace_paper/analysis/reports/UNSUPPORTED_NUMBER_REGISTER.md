...
| U4 | `kburtram_jspace.tex` header comment | source path `interpretability/jspace_runs/analysis/run_analysis.py` | script lives at `interpretability/jspace_paper/scripts/run_analysis.py` | stale pointer | fix path (stale register U8) |
