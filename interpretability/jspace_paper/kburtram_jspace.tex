...
%  \eid{...} bracket (registries: interpretability/jspace_phase3/reports/
%  evidence_events.jsonl and interpretability/jspace_part2/reports/
%  evidence_registry.jsonl); numbers were independently re-derived from the
%  item-level parquets by interpretability/jspace_paper/scripts/run_analysis.py
%  and re-verified by the paper-analysis reconstruction audit
%  (interpretability/jspace_paper/analysis/reports/RECONSTRUCTION_AUDIT.md).
%
