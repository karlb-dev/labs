...
package:       /content/labs/interpretability/jspaces/sidelines/gemma/
...
Never write to `interpretability/jspaces/phases/phase4/`,
`interpretability/jspaces/sidelines/olmo/`, either side track's registry, or the
