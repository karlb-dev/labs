...
HANDOUT_SOURCE_PATH = "interpretability/jspaces/phases/paper_analysis/gemma4_nonlinear_jacobian_handout.tex"
GEMMA_METADATA = Path(
...
SOURCE_REGISTRY = REPO_ROOT / "interpretability/jspaces/phases/phase2/reports/evidence_events.jsonl"
...
def _source_code_inventory(imports: list[dict]) -> dict[str, list[dict]]:
    ...
    for verified in imports:
        ...
        relative = f"interpretability/jspaces/phases/phase2/jspace_part2/experiments/{filename}"
        result[evidence_id] = [
