...
python -m jspace_olmo_lineage.experiments.geometry extract-readout \
  --config interpretability/jspaces/sidelines/olmo/configs/ol_geometry_v1.yaml \
...
python -m jspace_olmo_lineage.experiments.checkpoint_inventory \
  --config interpretability/jspaces/sidelines/olmo/configs/ol_checkpoint_inventory_v1.yaml
```
...
inspected. It deliberately does not edit `interpretability/jspaces/phases/paper_analysis`.

The model command is:

```bash
python -m jspace_olmo_lineage.experiments.capacity \
  --config interpretability/jspaces/sidelines/olmo/configs/ol_capacity_v1.yaml \
...
git add interpretability/jspaces/sidelines/olmo
