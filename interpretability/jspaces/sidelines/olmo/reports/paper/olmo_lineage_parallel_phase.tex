...
required prospectively. The outcome-blind Think/Instruct pair redesign also
has 16 shared families and power 0.7788 versus the frozen 0.80 target. No
Bank-W intervention cell was run. External-state substitution remains a
motivated hypothesis, not a resolved mechanism.
\end{warningbox}
...
Registry before release: & 36 live events, 145 verified outputs\\
...
An outcome-blind two-OLMo Bank-W redesign has 16 shared capable families and
power 0.7788 at the frozen SESOI, short of the 0.80 planning target; it opens no
intervention.
\end{abstract}
\tableofcontents
\clearpage
...
\nolinkurl{interpretability/jspaces/sidelines/olmo} namespace and Drive run root.
...
Bank-W factorial was gated out at 16/20; the pair-only redesign is underpowered
at the same 16-family support and resolves no mechanism\\
...
Bank W remains closed under version 1. The separately frozen Think/Instruct
pair ruler finds 16 shared capable families, all four type-I scenarios pass,
and conservative power is 0.7788 at the existing SESOI. Eighteen common
families are required for the 0.80 target
\eid{ol2-bank-w-olmo-pair-power-v1}. The mechanical route is
\texttt{not-powered-at-current-support}; this is planning evidence, not an
externalization null or intervention authorization.

\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{ol2_bank_w_olmo_pair_power.png}
\caption{Outcome-blind planning power for a possible Think/Instruct Bank-W
pair. The observed 16-family support remains below the frozen 0.80 target;
18 common capable families are required. No intervention outcome is read.}
\end{figure}
...
\begin{enumerate}
  ...
  \item \textbf{Externalization.} O4 is absent because the service population
    ...
    mechanism account. The outcome-blind pair power near-miss is not a
    scientific null.
...
remains unavailable rather than zero. Even the pair-only Bank-W redesign has
0.7788 power at its 16-family support and remains closed. These boundaries
favor new prospective capability and site-dose instrumentation over an
overextended mechanism claim.
...
figure derivative\\
\nolinkurl{ol2-bank-w-olmo-pair-power-v1} & methods & outcome-blind two-model
max-T planning ruler; 16 families are underpowered\\
...
\begin{itemize}
  ...
  \item H6 paper PNG/PDF: \texttt{03564b35...a7b1} and
    \texttt{b2745d9e...d610}.
  \item OLMo-pair power JSON: \texttt{4385af4b...200b}; PNG/PDF:
    \texttt{476ea886...64d} and \texttt{12faad50...ca0}.
\end{itemize}
...
event, 36 live events and 145 live outputs verify. The stable Study-2 handoff is
