...
EXTERNAL_REGISTRIES = {
    "phase3": REPO_ROOT / "interpretability/jspaces/phases/phase3/reports/evidence_events.jsonl",
    "phase4": REPO_ROOT / "interpretability/jspaces/phases/phase4/reports/evidence_events.jsonl",
}
...
def main() -> None:
    ...
    manifest = InputManifest(
        ...
        bank_sha256=file_sha256(
            REPO_ROOT / "interpretability/jspaces/sidelines/gemma/data/g1_prompts_v1.jsonl"),
