...
EARLY_OLMO_BUNDLE="interpretability/jspaces/phases/phase4/reports/OLMO_BANK_W_CAPABILITY_IMPORT_V1.json"
EARLY_OLMO_VALIDATION="interpretability/jspaces/phases/phase4/reports/olmo_bank_w_capability_import_validation_v1.json"
JOINT_CONFIG="interpretability/jspaces/phases/phase4/configs/p4_bank_w_joint_imported_dev_v1.yaml"
JOINT_REPORT="interpretability/jspaces/phases/phase4/reports/bank_w_capability_joint_imported_dev_v1.json"
JOINT_PNG="interpretability/jspaces/phases/phase4/reports/figures/p4f30_bank_w_joint_imported.png"
JOINT_PDF="interpretability/jspaces/phases/phase4/reports/figures/p4f30_bank_w_joint_imported.pdf"
GEMMA_BUNDLE="interpretability/jspaces/phases/phase4/reports/GEMMA_TRANSPORT_IMPORT_V1.json"
GEMMA_VALIDATION="interpretability/jspaces/phases/phase4/reports/gemma_transport_import_validation_v1.json"
FINAL_OLMO_BUNDLE="interpretability/jspaces/phases/phase4/reports/OLMO_LINEAGE_IMPORT_V1.json"
FINAL_OLMO_VALIDATION="interpretability/jspaces/phases/phase4/reports/olmo_lineage_import_validation_v1.json"
...
export PYTHONPATH="$PHASE4_ROOT:$REPO_ROOT/interpretability/jspaces/phases/phase3:$REPO_ROOT/interpretability/jspaces/phases/phase2${PYTHONPATH:+:$PYTHONPATH}"
