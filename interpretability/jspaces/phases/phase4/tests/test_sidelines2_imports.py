...
GEMMA_CONFIG = (
    REPO_ROOT / "interpretability/jspaces/phases/phase4/configs/"
    "p4_import_gemma_transport_study2.yaml")
OLMO_CONFIG = (
    REPO_ROOT / "interpretability/jspaces/phases/phase4/configs/"
    "p4_import_olmo_lineage_study2.yaml")
PHASE4_EVENTS = (
    REPO_ROOT / "interpretability/jspaces/phases/phase4/reports/"
...
NARRATIVE_DOCUMENTS = [
    ...
    "interpretability/jspaces/phases/phase4/manifests/parallel_import_inventory.md",
    "interpretability/jspaces/phases/phase4/reviews/"
...
def test_pre_freeze_policy_forbids_all_native_side_prefixes():
    policy = json.loads((
        REPO_ROOT / "interpretability/jspaces/phases/phase4/protocol/"
