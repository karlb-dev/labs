...
repo registry interpretability/jspaces/phases/phase4/reports/evidence_events.jsonl;
...
Run:  python interpretability/jspaces/phases/paper_analysis/analysis/scripts/reconstruct_qwen_ladder.py
...
PKG = REPO / "interpretability/jspaces/phases/phase4"
