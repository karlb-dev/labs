...
ANALYSIS = REPO / "interpretability/jspaces/phases/paper_analysis/analysis"
...
REGISTRIES = {
    ...
    "olmo_lineage": "interpretability/jspaces/sidelines/olmo/reports/evidence_events.jsonl",
    "phase3": "interpretability/jspaces/phases/phase3/reports/evidence_events.jsonl",
    "part2_events": "interpretability/jspaces/phases/phase2/reports/evidence_events.jsonl",
    "part2_registry": "interpretability/jspaces/phases/phase2/reports/evidence_registry.jsonl",
}
...
PAPER_SOURCE_DIRS = [
    "interpretability/jspaces/phases/paper_analysis",
    "interpretability/jspaces/phases/phase4/paper",
    "interpretability/jspaces/phases/phase4/reports/handout",
    "interpretability/jspaces/phases/phase4/release",
    ...
    "interpretability/jspaces/sidelines/olmo/release",
]
PAPER_SOURCE_FILES = [
    ...
    "interpretability/jspaces/phases/phase4/FREEZE_HANDOFF.md",
    "interpretability/jspaces/phases/phase3/reports/PHASE3_STATE_OF_RECORD.md",
    "interpretability/jspaces/sidelines/gemma/reports/GEMMA_TRANSPORT_DEVELOPMENT_REPORT.md",
    ...
    "interpretability/jspaces/sidelines/olmo/reports/OLMO_LINEAGE_STATE_OF_RECORD.md",
    "interpretability/jspaces/sidelines/olmo/reports/OLMO_LINEAGE_STATE_OF_RECORD_V2.md",
    "interpretability/jspaces/sidelines/olmo/reports/OLMO_LINEAGE_CLAIMS_TABLE.md",
    "interpretability/jspaces/sidelines/olmo/reports/OLMO_LINEAGE_CLAIMS_TABLE_V2.md",
    "interpretability/jspaces/sidelines/olmo/reports/OLMO_LINEAGE_DEVELOPMENT_REPORT.md",
...
def build_paper_manifest(tracked: set) -> list:
    ...
    for p in paths:
        ...
        if rel in seen or rel.startswith("interpretability/jspaces/phases/paper_analysis/analysis/"):
            continue
        seen.add(rel)
        if not p.exists():
