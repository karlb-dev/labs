...
#   REGISTRY  = interpretability/jspaces/phases/phase2/reports/evidence_registry.jsonl
# Writes:
#   interpretability/jspaces/phases/paper_analysis/analysis/tables/recon_phase2.csv
