...
| 3 | scaffold `interpretability/jspaces/phases/phase3/` package: run-root indirection (`JSPACE3_RUN_ROOT`), provenance/registry with `study_id=jspace-phase3`, tier vocabulary {phase2-confirmatory, phase3-development, phase3-confirmatory, phase3-replication} | §4.1–4.2, §15.1 |
