...
- Bootstrap mirror:
  `interpretability/jspaces/phases/phase2/reviews/special_lab_resume_mirror.md`
- The refreshed bootstrap mirror SHA-256 is
  ...
  byte identity.
- Governing plans:
  `interpretability/jspaces/phases/phase4/reviews/jspace_lab_nextsteps_4_2.md`
...
- Package: `interpretability/jspaces/phases/phase4/`
...
4. Draw A n=120 and its first structural comparison are complete and
   ...
   Run from `interpretability/jspaces/phases/phase4/` in the host GPU process.
