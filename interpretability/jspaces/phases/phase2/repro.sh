...
#   bash interpretability/jspaces/phases/phase2/repro.sh                 # install + selftest + env audit
#   bash interpretability/jspaces/phases/phase2/repro.sh <evidence-id>   # + verify/re-run that evidence
set -euo pipefail
