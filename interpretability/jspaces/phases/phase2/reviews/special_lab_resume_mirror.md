...
read `interpretability/jspaces/phases/phase1/REPORT_v2_ERRATA.md` before trusting any
...
bash interpretability/jspaces/phases/phase2/repro.sh
...
| Phase-3 package + registry | `labs/interpretability/jspaces/phases/phase3/`; event log `reports/evidence_events.jsonl` |
| Part-1 run dirs (frozen) | `special-lab-1/{2026-07-25_1726, 2026-07-26_v2}/` |
| repro package (in git) | `labs/interpretability/jspaces/phases/phase2/` — CLI `jspace-part2`, contract in `protocol/REPRO_CONTRACT.md` |
...
| published mirror of exploratory era | `labs/interpretability/jspaces/phases/phase1/part2_exploratory/` |
| Part-1 errata (read before citing Part 1) | `labs/interpretability/jspaces/phases/phase1/REPORT_v2_ERRATA.md` |
...
2. Every claim-bearing artifact has an **evidence_id** in the registry
   ...
   Verify/re-run: `bash interpretability/jspaces/phases/phase2/repro.sh <evidence-id>`.
