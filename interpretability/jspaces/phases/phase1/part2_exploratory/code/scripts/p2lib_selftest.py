# Self-tests for p2lib (the addendum §10 conformance utilities). CPU, fast.
# Run: python scripts/p2lib_selftest.py  -> prints PASS per group or dies.
import sys
...
from p2lib import (PhaseControlledAblator, RunningVectorMoments,
