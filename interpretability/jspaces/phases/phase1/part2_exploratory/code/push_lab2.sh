#!/bin/bash
# Mirror the live Part-2 lab into interpretability/jspaces/phases/phase1/part2_exploratory/ and push.
...
J="$REPO/interpretability/jspaces/phases/phase1/part2"
...
cd "$REPO"
git add interpretability/jspaces/phases/phase1/part2 interpretability/jspaces/phases/phase1/REPORT_v2_ERRATA.md
