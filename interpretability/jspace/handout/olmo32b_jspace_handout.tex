...
paper's full 33--92\% depth range. (The late-band CoT-lead re-read ---
phase c --- is running; it lands in the next refresh together with P5.)
...
% --- [v2 pending subsections: P3 phase c cot-lead-late (folds into the
% --- P3 subsection above), P5 CoT rescue, P6 seeds, phase Q Qwen —
% --- added as each lands; see inprogress.md]
...
(pipeline s0--s10 + PLAN/LOG). Model: \code{allenai/Olmo-3-32B-Think}.
Lens engine: \code{github.com/anthropics/jacobian-lens} @ \code{581d3986}.
