...
% --- [v2 pending subsections: P1 matched grid result (f11), P2 frozen
% --- ablation (f12), P3 late band (f13, f14), P5 CoT rescue, P6 seeds,
% --- phase Q Qwen — added as each lands; see inprogress.md for status]
