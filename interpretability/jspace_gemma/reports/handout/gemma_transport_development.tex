...
quadratically with radius. No current-study model result is reported at this
...
checkpointed, but final summary serialization stopped on a pandas integer
type. Cell hashes are preserved; no calibration result or Gemma threshold is
registered until a provenance-separating pure finalizer succeeds.
\end{document}
