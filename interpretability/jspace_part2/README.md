...
bash interpretability/jspace_part2/repro.sh                    # install + conformance tests + env audit
bash interpretability/jspace_part2/repro.sh <evidence-id>      # verify/re-run one evidence item
