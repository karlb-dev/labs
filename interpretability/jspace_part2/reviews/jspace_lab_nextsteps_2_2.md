...
1. an exploratory publication mirror under `interpretability/jspace/part2/`, containing the living report, figures, handout, master tables, mirrored results, and operational plans; and
2. a confirmatory-capable package under `interpretability/jspace_part2/`, containing reusable Python modules, configs, tests, a CLI, provenance machinery, an evidence registry, and the scientific preregistration draft.
...
- Make `interpretability/jspace_part2/` authoritative for executable code.
- Reduce `interpretability/jspace/part2/code/` to generated mirrors or pointers.
