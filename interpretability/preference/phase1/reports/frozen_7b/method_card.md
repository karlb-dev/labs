# method_card.md — Lab 38 behavioral_frozen

Frozen behavioral run under the preregistration.

Model: allenai/Olmo-3-7B-Instruct @ 6e5971d9eba42665f5bd5a0fcf047f299ce1dccc
(bfloat16). Bank lab38_v2_phase1
(content hash `8d5039af581204a5…`), codebook
`cb_final_41eec2d774`. Deterministic greedy decoding
(max_new_tokens 8);
margins = single-row full-sequence exact-target logprobs; strict parser
`strict_exact_code_v1`; invalid = missing (primary).
