...
- selected rows: 84 from 84
- required tools: `{'calculator': 10, 'calendar': 10, 'dictionary': 10, 'file_search': 10, 'none': 24, 'route_planner': 10, 'unit_converter': 10}`
- splits: `{'eval': 26, 'train': 58}`
- science-ready: `True`
...
|---|---|---|---:|---:|---|
| `prompt_boundary_tool_needed_decode` | DECODE | tool_needed_auc | 0.9236 | 0.3077 | `supported` |
| `prompt_boundary_tool_selection_decode` | DECODE | tool_selection_accuracy | 0.7692 | 0.3077 | `supported` |
| `constrained_action_letter_activation_addition` | CAUSAL | target_direction_shift_at_scale_1 | 0.0913 | -0.0207 | `supported_narrow_letter_prompt` |
