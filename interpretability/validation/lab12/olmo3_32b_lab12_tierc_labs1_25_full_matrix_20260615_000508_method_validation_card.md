...
| causal specificity | `not_validated_by_controls` | relation patch gap `-0.0539` |
| saved direction scope | model `allenai/Olmo-3-1125-32B`, depth by role `{'relword': 41, 'subject': 8, 'final': 9}` | `state/relation_directions_metadata.json` |
