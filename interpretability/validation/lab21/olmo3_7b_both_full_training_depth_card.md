...
1. `olmo3_7b_both_full_organism_discovery.json` and
   `olmo3_7b_both_full_adapter_source_manifest.csv` before trusting LoRA rows.
2. `olmo3_7b_both_full_lora_concentration_summary.csv` before naming a layer range.
3. `olmo3_7b_both_full_chat_format_divergence_summary_by_depth.csv` before reading safety-depth curves.
4. `olmo3_7b_both_full_safety_depth_signal_summary.csv` for the depth curves.
5. `olmo3_7b_both_full_training_depth_evidence_matrix.csv` for the joined evidence board.
6. `olmo3_7b_both_full_operationalization_audit.md` for the full non-claims and control posture.
