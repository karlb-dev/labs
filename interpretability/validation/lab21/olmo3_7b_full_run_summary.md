...
1. `olmo3_7b_full_training_depth_card.md` for the verdict and non-claims.
2. The primary `olmo3_7b_both_full_lab21_safety_wall.json` for the hard safety scope.
3. `olmo3_7b_full_training_depth_evidence_matrix.csv` for the evidence board.
4. Safety mode: `olmo3_7b_full_safety_depth_signal_summary.csv`.
