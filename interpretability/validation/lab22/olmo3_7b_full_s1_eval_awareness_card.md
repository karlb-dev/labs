...
- Best stream depth: 9
- Injection layer for steering: 8
- Held-out eval-vs-natural AUC: 0.9861
- Held-out eval-vs-format-control AUC: 0.9306
- Cross-format min / mean AUC: 0.9062 / 0.9635
- Cross-format min null-adjusted AUC gap: 0.0
- Best surface baseline AUC on eval split: 0.8681
