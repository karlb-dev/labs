...
-- READPAST under READ_COMMITTED_SNAPSHOT requires locking reads explicitly.
-- Keep UPDLOCK/ROWLOCK and add READCOMMITTEDLOCK so the durable queue works
-- under the control database's governed RCSI setting.
