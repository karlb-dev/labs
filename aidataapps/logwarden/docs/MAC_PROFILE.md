...
The original mac evidence was produced on `aidataapps-logwarden-mac`; the
portable profile is now merged into `aidataapps-logwarden`, while platform and
served-artifact identities keep any future mac rows outside the Colab campaign.
